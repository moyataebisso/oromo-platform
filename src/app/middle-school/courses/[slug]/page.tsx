...
export default function MiddleSchoolCourseDetailPage() {
  ...
  if (error || !course) {
    return (
      <div className="py-16 px-4 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">{error || 'This course does not exist.'}</p>
  ...
  return (
    <div className="py-8 px-4">
      <div className="mx-auto max-w-4xl">
        ...
        {/* Hero section */}
        <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500 rounded-2xl p-8 text-white mb-8">
              ...
              {lessons.map((lesson, index) => {
                ...
                return (
                  ...
                  >
                    <Card
                      className={cn(
                        'hover:shadow-md transition-all bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700',
                        isNext && 'ring-2 ring-blue-500',
                        isCompleted && 'bg-blue-50/50 dark:bg-blue-900/20'
                      )}
                    >
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              {isNext && (
                                <span className="text-xs bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-400 px-2 py-0.5 rounded-full">
                                  Up next
                                </span>
                              )}
                            </div>

...
export default function MiddleSchoolLessonPage() {
  ...
  const handleMarkComplete = async () => {
    ...
    try {
      ...
      await sb.from('middle_school_progress').upsert(
        {
      ...
      <div className="max-w-6xl mx-auto flex">
        ...
        <div className="hidden lg:block w-64 border-r border-gray-200 dark:border-gray-700 min-h-screen p-4 bg-white dark:bg-gray-800">
          ...
          <div className="space-y-1">
            {allLessons.map((l, index) => (
              <Link
                key={l.id}
                href={`/middle-school/courses/${course.slug}/lessons/${l.slug}`}
                className={cn(
        ...
        <div className="flex-1 p-6">
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            {prevLesson ? (
              <Link
                href={`/middle-school/courses/${course.slug}/lessons/${prevLesson.slug}`}
                className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
              >
            ...
            {nextLesson ? (
              <Link
                href={`/middle-school/courses/${course.slug}/lessons/${nextLesson.slug}`}

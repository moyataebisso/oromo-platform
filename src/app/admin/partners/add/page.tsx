...
export default function AddPartnerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let logoUrl = null
      if (logoFile) {
        logoUrl = await uploadLogo(finalSlug)
      }
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Add a new partner to the featured section</p>
        </div>
      </div>
                ...
                >
                  {isSubmitting || isUploading ? (
                    <>
                      ...
                      {isUploading ? 'Uploading Logo...' : 'Creating Partner...'}
                    </>
                  ) : (
                    'Add Partner'
                  )}

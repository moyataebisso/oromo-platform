...
const getAIResponse = (message: string): string => {
  ...
  if (lowerMessage.includes('hello') || lowerMessage.includes('hi') || lowerMessage.includes('hey')) {
    return "Akkam! (Hello!) Welcome to Odda Academy. I'm here to help you navigate our Academy, Careers, and Wiki sections. What would you like to know about?"
  }
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: "Akkam! 👋 I'm your Odda Academy assistant. I can help you find courses, jobs, wiki articles, or answer questions about Oromo culture. What would you like to know?",
      timestamp: new Date(),
    },
  ])
